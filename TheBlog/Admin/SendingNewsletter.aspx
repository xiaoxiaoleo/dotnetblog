<%@ Page Language="C#" ValidateRequest="false" MasterPageFile="~/Template.master" AutoEventWireup="true" CodeFile="SendingNewsletter.aspx.cs" Inherits="MB.TheBlog.UI.Admin.SendingNewsletter" Title="TheBlog - Sending Newsletter" %>
