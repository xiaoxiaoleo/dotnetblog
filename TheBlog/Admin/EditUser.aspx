...
<asp:Content ID="MainContent" ContentPlaceHolderID="MainContent" Runat="Server">
   ...
   <table  class="table"  cellpadding="2" style="width: 450px;">
   ...
   <mb:UserProfile ID="UserProfile1" runat="server" />
      ...
      <tr><td style="text-align: right;">
         ...
         <asp:Button  class="btn btn-primary" runat="server" ID="btnUpdateProfile" ValidationGroup="EditProfile" Text="Update" OnClick="btnUpdateProfile_Click" />
      </td></tr>
   </table>
</asp:Content>
